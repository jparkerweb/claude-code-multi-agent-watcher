...
const PREDEFINED_THEMES: Record<ThemeName, PredefinedTheme> = {
  ...
  neon: {
    ...
    description: 'Authentic cyberpunk aesthetic with electric cyan and neon glow effects',
    cssClass: 'theme-neon',
    preview: { primary: '#000000', secondary: '#0a0a0f', accent: '#00cccc' },
    colors: {
      primary: '#00cccc',
      primaryHover: '#00aaaa',
      primaryLight: '#003333',
      ...
      textTertiary: '#99ffff',
      textQuaternary: '#ccffff',
      borderPrimary: '#00ffff',
      borderSecondary: '#00cccc',
      borderTertiary: '#009999',
      accentSuccess: '#00ff41',
      accentWarning: '#ffff00',
      accentError: '#ff0080',
      accentInfo: '#8a2be2',
      shadow: 'rgba(0, 255, 255, 0.4)',
      shadowLg: 'rgba(0, 255, 255, 0.6)',
      hoverBg: 'rgba(0, 255, 255, 0.1)',
      activeBg: 'rgba(0, 255, 255, 0.2)',
      focusRing: '#00ffff'
    }
  },
  vintage: {
